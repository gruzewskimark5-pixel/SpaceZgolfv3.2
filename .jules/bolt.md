...
## 2026-08-30 - [Express Static Middleware Optimization]
**Learning:** Placing express.static before API routes forces a filesystem stat call on every API request.
**Action:** Always place express.static below API routes and just above the catch-all/fallback route handlers to avoid unnecessary I/O overhead on high-throughput endpoints.
