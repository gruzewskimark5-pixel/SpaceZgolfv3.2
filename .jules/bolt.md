...
## 2026-07-08 - Optimize express.static placement
**Learning:** Placing express.static before API routes in Express forces a filesystem stat call on every API request.
**Action:** Optimize by placing express.static below API routes to prevent unnecessary I/O overhead on high-throughput endpoints.
