...
app.get('/api/leaderboard', async (req, res) => {
  try {
    ...
    if (leaderboardCache) {
      ...
      // ⚡ Bolt: Provide the precomputed ETag to skip the synchronous MD5 hashing overhead in Express.js res.send()
    ...
    // ⚡ Bolt: Precompute ETag to avoid synchronous hashing overhead in Express.js
