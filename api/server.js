...
app.get('/api/leaderboard', async (req, res) => {
  try {
    ...
    // ⚡ Bolt: Inline mapRow logic and calculations directly in the loop to avoid closure and function call overhead.
    // Also replacing .toFixed() with integer math (Math.round) to avoid expensive string allocations.
    if (supabase) {
